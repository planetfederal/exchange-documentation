...
wheel:
	...
	find $(BUILDDIR) ! -name '*.whl' -type f -exec rm -f {} +
	find $(BUILDDIR) ! -name 'build' -type d -exec rm -rf {} +
	@echo
	@echo "Build finished. The WHEEL file is located in $(BUILDDIR)."
...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/exchange-learning.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/exchange-learning.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/exchange-learning"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/exchange-learning"
	@echo "# devhelp"
